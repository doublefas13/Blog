<template>
  <router-link :to="`post/${post?.id}`">
    <CardBasic
      class="flex flex-col gap-4 min-w-[440px] max-h-[800px] justify-center min-h-[400px]"
    >
      <div
      ...
      <div class="flex p-2 gap-1 flex-row">
        ...
        <div class="flex flex-row justify-between w-full items-center">
          ...
          <div class="flex gap-1 flex-row">
            ...
            <div @click.stop.prevent="likePost()">
              <i
      ...
      <div class="p-2">
        ...
        <div class="flex flex-row gap-1 text-sm text-primary-grey p-4">
          <div v-for="(tags, index) in post?.tags" :key="index">
            #{{ tags }}
          </div>
        </div>
      </div>
